...
import { OMNIDEF } from './testTestEnglish_def.js';
import tmpl from './testTestEnglish.html';
import tmpl_nds from './testTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
